...
test.describe('Teste do estado atual da detecção de sequências', () => {
  test('deve verificar se a função getMovieSequels está funcionando', async ({
    page,
  }) => {
    console.log('🚀 Testando estado atual da função getMovieSequels...');
    ...
    console.log('✅ Teste do estado atual concluído!');
  });
});
