...
test('Teste funcional do botão de Diretores', async ({ page }) => {
  console.log('🚀 Iniciando teste do botão de diretores...');

  // Acessar a página sem esperar networkidle
  ...
  // Capturar screenshot
  await page.screenshot({ path: 'test-results/directors-working-test.png' });
